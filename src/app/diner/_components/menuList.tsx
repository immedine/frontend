...
import CardIcon from "@/components/layout/svg/Card";
import ListIcon from "@/components/layout/svg/List";
import SimpleAccordion from "@/components/ui/SimpleAccordion";
import MoonIcon from "@/components/layout/svg/Moon";
import SunIcon from "@/components/layout/svg/Sun";
    ...
    <>
      {userData?.loading ? <SplashScreen /> :
        <>
          ...
          <SimpleAccordion
            topBar={<AppHeader restaurantId={restaurantId} />}
            contentChildren={<div className={`flex justify-between px-4 pb-4 bg-[#f5b042]`} style={{
            ...
            `}
              ...
              >
                <ListFilter fontSize={14} color={!userData?.dark ? "white" : "black"} />
